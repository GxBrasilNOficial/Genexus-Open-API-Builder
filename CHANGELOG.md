...
- B081 (2026-08-08): relatório final pós-aplicação após Wizard, Sync (incluindo sem diff) e Remover — diálogo com criados/atualizados/removidos/bloqueados/avisos, Output `[B081]`, Abrir objeto principal, wrap e altura ajustada. Validado no U15 em `Teste`. Teste `Tests/ApplicationFinalReport/Test-ApiPlanApplicationFinalReport.ps1`. Manifesto inalterado (só DLL). Evidência: `Docs/Implementation/B081-RELATORIO-FINAL-POS-APLICACAO.md`.
