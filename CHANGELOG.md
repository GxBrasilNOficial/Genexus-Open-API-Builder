...
- `S-B111 F1` (2026-09-10): validação manual parcial na IDE da matriz positiva do Wizard, da guarda de API já REST-completa e do Sync `BC + List` com delta `NotaFiscalObs2` 40→41; a Output confirmou consumidores antes do API Object e um único `API.Save()` final; `Build All` passou em `NETPostgreSQL155` e `NETFrameworkSQLServer004`. Os demais cenários de Sync do plano permanecem sem evidência separada. Evidência: `Docs/Implementation/2026-09-10-S-B111-F1-ACEITE-IDE.md` e `Docs/Implementation/2026-09-10-S-B111-F1-RECONCILIACAO-EVIDENCIA.md`.
...
- `B108` (plano aprovado 2026-08-31; estacionado desde 2026-09-05): preferências só na criação; reencontro espelha KB; desmarcar confirma e rebaixa/remove no Apply (Delete some com BC). Plano: `Docs/Implementation/2026-08-31-B108-PLANO-PREFERENCIAS-E-RETRACAO.md`. A próxima ação única é fechar a lacuna de evidência manual do Sync da F1 antes de preparar a avaliação da F2 da sprint `S-B111`; ver o checkpoint, o documento 06 e a reconciliação `Docs/Implementation/2026-09-10-S-B111-F1-RECONCILIACAO-EVIDENCIA.md`.
