...
- Suporte paralelo Gx18u13 iniciado (2026-08-12): instalação local do GeneXus 18 U13 corroborou `N=143920`, referências pinadas foram copiadas para a área local ignorada e o satélite `Src/GenexusOpenApiBuilder.Gx18u13.sln` compilou em Release com inventário offline aprovado. A carga funcional na IDE U13 permanece pendente. Sem alterar a instalação protegida do GeneXus. Evidência: `Docs/Implementation/2026-08-12-FASE2-SATELITE-GX18U13.md`.
