...
**Remissão — 2026-08-29.** A forma por contrato permanece. Se o SDT aninhado de um papel ficaria com 0 membros (Create só com PK herdada), aquele SDT e a coleção no pai daquele papel não são emitidos. `ListFilters` sem filtros continua um SDT vazio de propósito.
