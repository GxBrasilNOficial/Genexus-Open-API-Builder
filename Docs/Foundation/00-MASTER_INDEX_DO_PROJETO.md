...
**Status técnico:** Extensão em linha Alpha; Sprint 9 com UX de progresso e cancelamento (`B082`) publicado em `0.1.0-alpha.7`; próxima ação no [checkpoint](../STATUS_ATUAL_E_PROXIMO_PASSO.md)
**Status público:** Repositório público; releases Alpha no GitHub (corte vigente `0.1.0-alpha.7`)
**Idioma:** Português BR
