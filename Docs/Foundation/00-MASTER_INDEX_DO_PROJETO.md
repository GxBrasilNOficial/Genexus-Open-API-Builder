...
**Status técnico:** Extensão em linha Alpha; Sprint 9 com subníveis preparados em `0.1.0-alpha.5` (tag e GitHub Release ainda não publicados); próxima frente `B100`
**Status público:** Repositório público; releases Alpha no GitHub (último publicado `0.1.0-alpha.4`; `0.1.0-alpha.5` preparado)
**Idioma:** Português BR
