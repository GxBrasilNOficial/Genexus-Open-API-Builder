...
| B128 | Gate incremental no pré-push para reduzir a entrada de novas referências C# por linha móvel em `Docs/` e validar citações históricas fixas novas | **Implementado, revisado e validado offline em 2026-09-23; commit local em `main`, sem push.** O contrato v8 substitui a decisão antiga Nível 1/Nível 2: não migra referências legadas e não prova semântica; impede aumento global dos tokens móveis reconhecidos e valida os endereços fixos excedentes contra commit ancestral, blob C# e linhas físicas existentes. Medeu 45 ocorrências em 37 linhas de cinco planos; não migradas. Integra `docs.csharpLineReferences`, tokenizer comum ao checker/teste, aviso heurístico não bloqueante para referência numérica provável ao `CHANGELOG` e `notCovered` explícito. Evidência e limites: `Docs/Implementation/2026-09-23-B128-IMPLEMENTACAO-E-GATES.md`; contrato: `Temp/revisao-por-pares/B128-20260923-0925/manuscrito-v8.md` |
