...
| B108 | Preferências da KB só na criação; no reencontro checkboxes espelham a KB; desmarcar confirma e rebaixa/remove no Apply (Delete some com BC) | Alta — planejado e aprovado (2026-08-31); **estacionado desde 2026-09-05**; a próxima ação única é preparar a avaliação da F2 da sprint `S-B111` após o fechamento da validação manual da F1 com a exceção explícita do `B121`, registrada em 2026-09-10/11; plano em `Docs/Implementation/2026-08-31-B108-PLANO-PREFERENCIAS-E-RETRACAO.md` e reconciliação em `Docs/Implementation/2026-09-10-S-B111-F1-RECONCILIACAO-EVIDENCIA.md` |
