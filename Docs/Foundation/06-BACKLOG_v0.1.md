...
| B082 | Mostrar tempo execução / sinal de vida | Média — **Fases A+B em código** (2026-08-31); Preview do Sync (2026-09-01); corte `0.1.0-alpha.7`. Etapa 1A **aceita** em 2026-09-03 (`Docs/Implementation/2026-09-03-B082-ETAPA-1A-ACEITE.md`). A F2 da sprint `S-B111` foi aceita em 2026-09-13; a F3 e a sprint foram encerradas em 2026-09-15 (no encerramento, o residual 1B/2/3 ficou fora da sprint e da pauta imediata). **Retomada em duas sessões (2026-09-16):** Etapas **2** e **3** fechadas; **resta Etapa 1B** (adiada) no plano; **não displace `B122`** sem priorização humana. **`B108` está estacionado**. Não misturar com `B108` |
...
`B082` Fases A+B estão em código desde 2026-08-31, integrando o corte `0.1.0-alpha.7`. Desde 2026-09-02 o residual (casca × B081 no Apply/Sync; `progress` na revalidação do Remove; índice incompleto) foi medido no plano `Docs/Implementation/2026-09-02-B082-PLANO-HARDENING-E-DESEMPENHO.md`; a Etapa 1A foi **aceita** em 2026-09-03 (`Docs/Implementation/2026-09-03-B082-ETAPA-1A-ACEITE.md`). Após a retomada de 2026-09-16, Etapas **2** e **3** fechadas; **resta Etapa 1B** (adiada) nesse plano, sem ser a próxima ação única; a F1 da sprint `S-B111` foi autorizada, implementada e recebeu validação manual para encerramento com a exceção explícita do `B121` em 2026-09-10/11 (`Docs/Implementation/2026-09-10-S-B111-F1-RECONCILIACAO-EVIDENCIA.md`). A `Empresa` em 2026-08-29 motivou o sinal de vida; Apply ~4,2 min em 2026-08-31; Preview do Sync (`5089` ms) e do Remover (`2525` ms, Não) em 2026-09-01.
