...
| B100 | Serviço `Delete` opt-in, com confirmação consciente, `SecurityLevel` próprio e documentação pública | Alta — Sprint 9 / após a Fase 7, corte `0.1.0-alpha.6`; concluído (2026-08-30; HTTP 401/404/200 nos dois environments, 422 no Framework) |
