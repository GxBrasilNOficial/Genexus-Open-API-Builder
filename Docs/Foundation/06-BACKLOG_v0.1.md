...
### Nota operacional — B100 a B104, registrada em 2026-08-23

Os cinco itens nasceram da mesma revisão e **não pertencem** à frente de subníveis; cada um tem gate próprio. `B102` e `B100` executam dentro da Sprint 9; `B101` e `B103` são candidatos à Sprint 10; `B104` fica para depois da Sprint 9.
