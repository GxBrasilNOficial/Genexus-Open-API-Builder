...
| B108 | Preferências da KB só na criação; no reencontro checkboxes espelham a KB; desmarcar confirma e rebaixa/remove no Apply (Delete some com BC) | Alta — planejado e aprovado (2026-08-31); **estacionado desde 2026-09-05**; a próxima ação única é a revisão por pares da sprint `S-B111`; plano em `Docs/Implementation/2026-08-31-B108-PLANO-PREFERENCIAS-E-RETRACAO.md` |
...
Cursor respondeu `APROVAR COM RESSALVAS`, suas ressalvas úteis foram aplicadas e a decisão
...
`B082` Fases A+B estão em código desde 2026-08-31, integrando o corte `0.1.0-alpha.7`. Desde 2026-09-02 o residual (casca × B081 no Apply/Sync; `progress` na revalidação do Remove; índice incompleto) foi medido no plano `Docs/Implementation/2026-09-02-B082-PLANO-HARDENING-E-DESEMPENHO.md`; a Etapa 1A foi **aceita** em 2026-09-03 (`Docs/Implementation/2026-09-03-B082-ETAPA-1A-ACEITE.md`). Residual 1B/2/3 permanece nesse plano, sem ser a próxima ação única; a próxima ação é a revisão por pares da sprint `S-B111`. A `Empresa` em 2026-08-29 motivou o sinal de vida; Apply ~4,2 min em 2026-08-31; Preview do Sync (`5089` ms) e do Remover (`2525` ms, Não) em 2026-09-01.
