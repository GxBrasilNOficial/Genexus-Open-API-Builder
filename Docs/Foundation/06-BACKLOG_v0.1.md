...
| B082 | Mostrar tempo execução / sinal de vida | Média — **Fases A+B em código** (2026-08-31); Preview do Sync (2026-09-01); corte `0.1.0-alpha.7`. Etapa 1A **aceita** em 2026-09-03 (`Docs/Implementation/2026-09-03-B082-ETAPA-1A-ACEITE.md`). A F2 da sprint `S-B111` foi aceita em 2026-09-13; os residuais 1B/2/3 seguem no plano de 2026-09-02 e serão reavaliados após a F3 no checkpoint. **`B108` está estacionado**. Não misturar com `B108` |
