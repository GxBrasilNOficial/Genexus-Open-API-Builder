...
`B082` Fases A+B estão em código desde 2026-08-31, integrando o corte `0.1.0-alpha.7`. Desde 2026-09-02 o residual (casca × B081 no Apply/Sync; `progress` na revalidação do Remove; índice incompleto) foi medido no plano `Docs/Implementation/2026-09-02-B082-PLANO-HARDENING-E-DESEMPENHO.md`; a Etapa 1A foi **aceita** em 2026-09-03 (`Docs/Implementation/2026-09-03-B082-ETAPA-1A-ACEITE.md`). Residual 1B/2/3 permanece nesse plano, sem ser a próxima ação única; a F1 da sprint `S-B111` foi autorizada, implementada e recebeu validação manual para encerramento com a exceção explícita do `B121` em 2026-09-10/11 (`Docs/Implementation/2026-09-10-S-B111-F1-RECONCILIACAO-EVIDENCIA.md`). A `Empresa` em 2026-08-29 motivou o sinal de vida; Apply ~4,2 min em 2026-08-31; Preview do Sync (`5089` ms) e do Remover (`2525` ms, Não) em 2026-09-01.
