...
O texto gerado é `REST API for <Transaction>, generated by Genexus Open API Builder`, em inglês, para acompanhar o idioma das descrições por serviço resolvidas em B056. Sem ponto terminal (padrão usual de Description de objeto GeneXus). A forma legada com ponto final permanece aceita no fallback B087 e na integridade B067.
...
Essa acumulação de papéis é dívida conhecida e ficou mais arriscada depois que o texto passou a ser legível. `B087` separa os dois papéis (posse na metadata; `Description` editável), foi implementado e validado no U15 em 2026-08-07; ver `Docs/Implementation/B087-POSSE-API-OBJECT-METADATA.md` e a nota operacional no documento 06.
