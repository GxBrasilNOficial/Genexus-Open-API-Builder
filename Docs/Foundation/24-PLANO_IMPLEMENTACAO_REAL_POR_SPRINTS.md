...
- `B099a`: Interface do Wizard com agrupamento por nível, dependência entre níveis, controle de contador e aviso de profundidade (**concluído em 2026-08-26**; evidência `Docs/Implementation/2026-08-26-B099a-WIZARD-HIERARQUICO.md`)
