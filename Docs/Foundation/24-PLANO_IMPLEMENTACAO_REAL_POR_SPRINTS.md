...
- `B082`: sinal de vida no Wizard (abertura/apply) e no Remover — **Fases A+B em código** (2026-08-31); Fase C/D pendentes; fora da linha de corte do MVP e fora do corte `0.1.0-alpha.5`; plano `Docs/Implementation/2026-08-31-B082-PLANO-UX-PROGRESSO.md`; recado `Docs/Implementation/2026-08-29-UX-PROGRESSO-WIZARD-APPLY.md`
