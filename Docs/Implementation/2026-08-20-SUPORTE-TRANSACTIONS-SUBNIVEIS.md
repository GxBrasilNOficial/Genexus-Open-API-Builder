...
**Atualização de 2026-08-28 (B099b).** Fase 6 (`B099b`) concluída: metadata `GOAB_API_METADATA_B060_V2` com `levels` e `objects.sdts.own`; leitura tolerante V1+V2; Sync hierárquico; Remover com inventário gravado; smoke U15 na `Teste`/`apiTeste` (Wizard, Sync, Remover). Próxima frente planejada = Fase 7 (não iniciada). Evidência: `Docs/Implementation/2026-08-28-B099b-METADATA-HIERARQUICA-V2.md`.
