...
**Atualização de 2026-08-31 (publicação `0.1.0-alpha.6`).** Tag `v0.1.0-alpha.6` e GitHub Release pre-release com os dois assets DLL. ~~Próxima ação operacional = `B108` (plano aprovado e gravado; código adiado).~~ ~~Desde 2026-09-03, `B108` é de novo a próxima ação única (1A do `B082` aceita).~~ **Superada em 2026-09-05:** `B108` foi estacionado e a pauta imediata passou a ser a revisão por pares da sprint `S-B111`. Plano: [2026-08-31-B108-PLANO-PREFERENCIAS-E-RETRACAO.md](2026-08-31-B108-PLANO-PREFERENCIAS-E-RETRACAO.md). Evidência: [Release](https://github.com/GxBrasilNOficial/Genexus-Open-API-Builder/releases/tag/v0.1.0-alpha.6).
