...
- `B082` (progresso na UI): Fases A+B em código (2026-08-31) — `Docs/Implementation/2026-08-31-B082-PLANO-UX-PROGRESSO.md`. Desde 2026-09-02 o residual foi medido no plano `Docs/Implementation/2026-09-02-B082-PLANO-HARDENING-E-DESEMPENHO.md`; a Etapa 1A foi **aceita** em 2026-09-03 (`Docs/Implementation/2026-09-03-B082-ETAPA-1A-ACEITE.md`). Na data deste registro, a próxima ação única do checkpoint era `B108`; essa referência histórica foi superada em 2026-09-05, quando `B108` foi estacionado e a pauta passou a ser a revisão por pares da sprint `S-B111`.
