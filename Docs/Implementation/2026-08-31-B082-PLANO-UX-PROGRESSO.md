...
5. **Higiene doc checkpoint (P3, opcional).** Itens 91+ na «Sequência operacional vigente» do checkpoint para trabalho 2026-09-01 (Preview Sync com casca; `RefreshFolders` após `GxOpenAPI`). Origem: painel Claude 2026-09-01. Fechar quando: sequência numerada reflete marcos pós-item 90 sem contradizer a próxima ação vigente na data do item.

Isso deixou de ser fila parada em 2026-09-02 e virou pauta de código até a aceite da Etapa 1A em 2026-09-03 (`Docs/Implementation/2026-09-03-B082-ETAPA-1A-ACEITE.md`); após a retomada de 2026-09-16, Etapas **2** e **3** fechadas; **Remissão — 2026-09-17:** Etapa 1B aceita com ressalva de relógio e residual `B082` **fechado** (`Docs/Implementation/2026-09-17-B082-ETAPA-1B-ACEITE.md`).
...
- Checkpoint: `Docs/STATUS_ATUAL_E_PROXIMO_PASSO.md` (naquele momento, a próxima ação de código era `B108`; Etapa 1A do plano de 2026-09-02 **aceita** em 2026-09-03 — `Docs/Implementation/2026-09-03-B082-ETAPA-1A-ACEITE.md`; no checkpoint atual, a pauta imediata é a revisão por pares da sprint `S-B111`; este arquivo é registro, não pauta)
