...
Checkpoint: `Docs/STATUS_ATUAL_E_PROXIMO_PASSO.md`. Desde 2026-09-05 este plano está estacionado. A sprint `S-B111` (F1–F3) foi encerrada em 2026-09-15, mantendo `B121` fora dela; este plano permanece estacionado. Remissão — 2026-09-18: o `B122` foi fechado; a próxima ação única vigente no checkpoint é `B123` (posse histórica do Folder). Escopo inalterado.
