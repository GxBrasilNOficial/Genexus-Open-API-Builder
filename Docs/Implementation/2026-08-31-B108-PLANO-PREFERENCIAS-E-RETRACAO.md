...
Checkpoint: `Docs/STATUS_ATUAL_E_PROXIMO_PASSO.md`. Desde 2026-09-05 este plano está estacionado; após o aceite manual da F1 da sprint `S-B111` em 2026-09-10, a **próxima ação única** é preparar a avaliação da F2. Escopo inalterado.
