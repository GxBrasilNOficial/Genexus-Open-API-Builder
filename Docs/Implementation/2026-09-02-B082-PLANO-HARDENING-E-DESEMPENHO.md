...
em 2026-09-05**: `B108` foi estacionado e a próxima ação única passou a ser decidir o encerramento
 ...
 recebeu validação manual para encerramento com a exceção explícita do `B121` em 2026-09-10/11. O residual 1B/2/3 permanece neste plano. No encerramento da `S-B111` (2026-09-15) o checkpoint reavaliou esse residual e o manteve fora da pauta imediata; a sprint não fechou automaticamente o `B082`.
