...
A solução e o pacote mínimos são restauráveis e compiláveis sem depender da instalação do GeneXus. B000–B006 e B020 foram concluídos posteriormente no U15; a próxima frente operacional vigente deve ser consultada em `Docs/STATUS_ATUAL_E_PROXIMO_PASSO.md`.
