...
A solução e o pacote mínimos são restauráveis e compiláveis sem depender da instalação do GeneXus. B000–B006 foram concluídos posteriormente no U15; a próxima frente operacional é B020, conforme `Docs/STATUS_ATUAL_E_PROXIMO_PASSO.md`.
