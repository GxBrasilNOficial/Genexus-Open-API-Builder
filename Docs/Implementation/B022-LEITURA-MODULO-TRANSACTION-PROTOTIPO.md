...
`Src/Extension/Package.cs` registra o comando B022 e concentra o fluxo manual: verifica a KB ativa, abre o seletor nativo, lê o módulo e escreve o resultado na Output. `Src/Extension/Diagnostics/PrototypeTransactionSelection.cs` mantém o estado efêmero que será reutilizado pela frente B023.
