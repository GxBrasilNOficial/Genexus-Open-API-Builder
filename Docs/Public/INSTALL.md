...
No GitHub Release `0.1.0-alpha.3`, baixe somente um dos arquivos:
...
- Notas de release: [0.1.0-alpha.3](../Releases/0.1.0-alpha.3.md)
- Español: [notas 0.1.0-alpha.3](../Releases/0.1.0-alpha.3.es.md)
- English: [release notes 0.1.0-alpha.3](../Releases/0.1.0-alpha.3.en.md)
