...
10. Sprint 5 validou B055: Create e Update usam Business Component nas Procedures já geradas e o API Object é sincronizado com assinatura e variáveis compatíveis, cobrindo chave simples, chave composta e atributos baseados em domínio nos SDTs de request/response, sem completar REST, códigos HTTP, segurança definitiva ou metadata persistente.
