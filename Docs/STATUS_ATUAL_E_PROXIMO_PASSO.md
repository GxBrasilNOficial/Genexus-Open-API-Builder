...
4. Sprint 3 iniciou metadata e `ApiPlan` com B038, registrou representação provisória de B090/B091/B092 em memória, resolveu e validou os campos escalares `GeneratorTarget`, `ConflictMode` e `ReexecutionMode`, e continua com B090/B091 canônicos abertos para configuração por KB de sensíveis/auditoria, descrições/idioma/fallback pendentes para B056, condição GAM pendente e preparação da futura metadata persistente.
