...
Public alpha: **[`0.1.0-alpha.6`](https://github.com/GxBrasilNOficial/Genexus-Open-API-Builder/releases/tag/v0.1.0-alpha.6)** — choose the DLL matching your GeneXus version in the Release.
...
| Public alpha `0.1.0-alpha.6` | Release package (opt-in `Delete`) with U14+ and U13 assets |
...
Release `0.1.0-alpha.6` contains two DLLs. Install only the one corresponding to your installation:
...
3. Read the [Alpha notes](Docs/Releases/0.1.0-alpha.6.en.md)
...
| [0.1.0-alpha.6](Docs/Releases/0.1.0-alpha.6.en.md) | EN notes; [PT-BR](Docs/Releases/0.1.0-alpha.6.md); [ES](Docs/Releases/0.1.0-alpha.6.es.md) — DLL selection |
