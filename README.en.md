...
Public alpha: **[`0.1.0-alpha.5`](https://github.com/GxBrasilNOficial/Genexus-Open-API-Builder/releases/tag/v0.1.0-alpha.5)** — choose the DLL matching your GeneXus version in the Release.
...
| Public alpha `0.1.0-alpha.5` | Release package (sublevels) with U14+ and U13 assets |
...
Release `0.1.0-alpha.5` contains two DLLs. Install only the one corresponding to your installation:
...
3. Read the [Alpha notes](Docs/Releases/0.1.0-alpha.5.en.md)
...
| [0.1.0-alpha.5](Docs/Releases/0.1.0-alpha.5.en.md) | EN notes; [PT-BR](Docs/Releases/0.1.0-alpha.5.md); [ES](Docs/Releases/0.1.0-alpha.5.es.md) — DLL selection |
