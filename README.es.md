...
Alpha pública: **[`0.1.0-alpha.6`](https://github.com/GxBrasilNOficial/Genexus-Open-API-Builder/releases/tag/v0.1.0-alpha.6)** — elija la DLL correspondiente a su versión de GeneXus en el Release.
...
| Alpha pública `0.1.0-alpha.6` | Paquete de esta release (`Delete` opt-in), con assets U14+ y U13 |
...
El Release `0.1.0-alpha.6` contiene dos DLLs. Instale solamente la correspondiente a su instalación:
...
3. Leer las [notas de la Alpha](Docs/Releases/0.1.0-alpha.6.es.md)
...
| [0.1.0-alpha.6](Docs/Releases/0.1.0-alpha.6.es.md) | Notas ES; [PT-BR](Docs/Releases/0.1.0-alpha.6.md); [EN](Docs/Releases/0.1.0-alpha.6.en.md) — elección de la DLL |
