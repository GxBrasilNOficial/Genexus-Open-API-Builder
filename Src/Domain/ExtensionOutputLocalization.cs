...
internal static class ExtensionOutputLocalization
{
    ...
    private static readonly Phrase[] Phrases =
    {
        ...
        new("criado pela extensão; será preservado — Description ou contêiner divergente", "creado por la extensión; se preservará — Description o contenedor divergente", "created by the extension; will be preserved — Description or container diverge"),
        new("próprio da API; será preservado — Description ou contêiner divergente", "propio de la API; se preservará — Description o contenedor divergente", "owned by the API; will be preserved — Description or container diverge"),
        new("nao foi apagado porque a Description ou o contenedor divergem do esperado.", "no se eliminó porque la Description o el contenedor divergen de lo esperado.", "was not deleted because the Description or the container diverge from what was expected."),
