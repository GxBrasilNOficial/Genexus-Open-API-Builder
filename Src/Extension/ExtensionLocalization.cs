    ...
    public string Translate(string source)
    {
        ...
        return Language == ExtensionLanguage.Spanish
            ? source switch
            {
                ...
                "Foi encontrada uma API gerada pela extensao sem o File de metadata '{0}'. A recuperacao criara somente esse File, nao alterara API Object, Procedures ou SDTs, e encerrara esta aplicacao para uma nova leitura limpa. Deseja recuperar agora?" => "Se encontró una API generada por la extensión sin el archivo de metadatos '{0}'. La recuperación creará solo ese archivo, no cambiará el API Object, Procedures ni SDTs, y cerrará esta aplicación para una nueva lectura limpia. ¿Desea recuperar ahora?",
