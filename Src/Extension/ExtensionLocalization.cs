    ...
    public string Translate(string source)
    {
        ...
        return Language == ExtensionLanguage.Spanish
            ? source switch
            {
                ...
                "Profundidade não validada: a evidência da sprint cobre até 3 níveis. A geração não é bloqueada; desmarque os níveis mais profundos se não quiser incluí-los." => "Profundidad no validada: la evidencia de la sprint cubre hasta 3 niveles. La generación no se bloquea; desmarque los niveles más profundos si no quiere incluirlos.",
                "Metadata, sincronização e remoção ainda são V1: não use Remover API gerada nem Sincronizar com a Transaction nesta API até B099b." => "Metadatos, sincronización y eliminación siguen en V1: no use Eliminar API generada ni Sincronizar con la Transaction en esta API hasta B099b.",
            ...
            : source switch
            {
                ...
                "Profundidade não validada: a evidência da sprint cobre até 3 níveis. A geração não é bloqueada; desmarque os níveis mais profundos se não quiser incluí-los." => "Unvalidated depth: sprint evidence covers up to 3 levels. Generation is not blocked; clear the deeper levels if you do not want to include them.",
                "Metadata, sincronização e remoção ainda são V1: não use Remover API gerada nem Sincronizar com a Transaction nesta API até B099b." => "Metadata, sync, and removal are still V1: do not use Remove generated API or Synchronize with the Transaction on this API until B099b.",
