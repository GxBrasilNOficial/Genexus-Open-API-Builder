    ...
    public string Translate(string source)
    {
        ...
        return Language == ExtensionLanguage.Spanish
            ? source switch
            {
                ...
                "Oferecer recuperação de metadata órfã no Wizard" => "Ofrecer recuperación de metadatos huérfanos en el Wizard",
                "Habilitar Business Component agora" => "Habilitar Business Component ahora",
                "Foi encontrada uma API gerada pela extensão sem o File de metadata '{0}'. A recuperação criará somente esse File, não alterará API Object, Procedures ou SDTs, e encerrará esta aplicação para uma nova leitura limpa. Deseja recuperar agora?" => "Se encontró una API generada por la extensión sin el archivo de metadatos '{0}'. La recuperación creará solo ese archivo, no cambiará el API Object, Procedures ni SDTs, y cerrará esta aplicación para una nueva lectura limpia. ¿Desea recuperar ahora?",
                "A metadata '{0}' foi recuperada. Reabra o Wizard para continuar; nenhuma outra etapa foi executada nesta aplicação." => "Los metadatos '{0}' fueron recuperados. Abra nuevamente el Wizard para continuar; no se ejecutó ninguna otra etapa en esta aplicación.",
                "A recuperação da metadata '{0}' falhou: {1}" => "La recuperación de los metadatos '{0}' falló: {1}",
            ...
            : source switch
            {
                ...
                "Oferecer recuperação de metadata órfã no Wizard" => "Offer orphan metadata recovery in the Wizard",
                "Habilitar Business Component agora" => "Enable Business Component now",
                "Foi encontrada uma API gerada pela extensão sem o File de metadata '{0}'. A recuperação criará somente esse File, não alterará API Object, Procedures ou SDTs, e encerrará esta aplicação para uma nova leitura limpa. Deseja recuperar agora?" => "An extension-generated API was found without the metadata File '{0}'. Recovery will create only that File, will not change the API Object, Procedures, or SDTs, and will close this application for a clean reread. Recover now?",
                "A metadata '{0}' foi recuperada. Reabra o Wizard para continuar; nenhuma outra etapa foi executada nesta aplicação." => "Metadata '{0}' was recovered. Reopen the Wizard to continue; no other stage was executed in this application.",
                "A recuperação da metadata '{0}' falhou: {1}" => "Metadata recovery for '{0}' failed: {1}",
