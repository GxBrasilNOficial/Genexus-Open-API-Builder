...
public sealed class Package : AbstractPackageUI
{
    ...
    private static bool ExecuteConfigureWizardPreferencesCore(CommandData data)
    {
        ...
        catch (Exception ex)
        {
            ...
            // B109: diagnostico permanente - publica a stack completa, que o log de uma linha descarta.
        ...
        ApiPlanRehydratedOperation operation)
    {
        ...
        var preservedOwnershipGateFolders = new List<string>();
        ...
        using (var busy = ExtensionBusyProgressScope.Show(owner, texts.BusyProgressTitleRemove, texts))
        {
            ...
            try
            {
                removal = ApiPlanGeneratedApiRemover.Execute(
                    ...
                    kbIndex: kbIndex,
                    preservedOwnershipGateFolderSink: preservedOwnershipGateFolders);
            }
            catch (ApiPlanBusyAbortedException abortEx)
            {
                ...
                abortReport.AddPreservedOwnershipGateFolders(preservedOwnershipGateFolders);
        ...
        report.AddPreservedOwnershipGateFolders(removal.PreservedOwnershipGateFolders);
    ...
    private static bool ExecuteRemoveGeneratedApiCore(CommandData data)
    {
        ...
        try
        {
            ...
            report.AddPreservedOwnershipGateFolders(result.PreservedOwnershipGateFolders);
        ...
        catch (Exception ex)
        {
            ...
            report.AddPreservedOwnershipGateFolders(preservedOwnershipGateFolders);
            if (deletedBeforeFailure.Count > 0)
            {
