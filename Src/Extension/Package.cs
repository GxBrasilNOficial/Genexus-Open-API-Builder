...
public sealed class Package : AbstractPackageUI
{
    ...
    private static bool ExecuteOpenWizardStepOne(CommandData data)
    {
        ...
        WriteOutput($"[Genexus Open API Builder][B033] Obrigatoriedade em memoria: CreateRequired={createRequiredCount}, UpdateRequired={updateRequiredCount}. Required marca membro obrigatorio no payload, recusado com 400 quando ausente ou vazio.");
