...
Assert-Contains $apiObjectWriterSource 'return $"REST API for {apiPlan.TransactionName}, generated by {OwnedDescriptionGeneratorName}.";' 'Descricao do API Object, publicada em info.description, deve seguir o formato acordado.'
