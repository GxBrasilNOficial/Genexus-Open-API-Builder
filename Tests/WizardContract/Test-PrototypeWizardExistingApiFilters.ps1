...
Assert-Contains $reader 'existingApiContract.ServicesAvailable ? false : true' 'Com ServicesAvailable, serviço ausente do contrato persistido permanece desmarcado (nao fallback true).'
