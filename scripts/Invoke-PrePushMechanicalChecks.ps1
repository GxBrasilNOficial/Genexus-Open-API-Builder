...
try {
    ...
    foreach ($unitTest in @(
        ...
        [ordered]@{ Name = 'tests.wizardContractInitialState'; RelativePath = 'Tests\WizardContract\Test-PrototypeWizardInitialState.ps1'; Command = 'pwsh -NoProfile -File Tests/WizardContract/Test-PrototypeWizardInitialState.ps1'; Passed = 'Teste unitário do contrato de wizard InitialState concluído.'; Failed = 'Teste unitário do contrato de wizard InitialState falhou.'; Missing = 'Teste unitário do contrato de wizard InitialState não encontrado.' },
        [ordered]@{ Name = 'tests.wizardContractServices'; RelativePath = 'Tests\WizardContract\Test-PrototypeWizardServices.ps1'; Command = 'pwsh -NoProfile -File Tests/WizardContract/Test-PrototypeWizardServices.ps1'; Passed = 'Teste unitário do contrato de wizard Services concluído.'; Failed = 'Teste unitário do contrato de wizard Services falhou.'; Missing = 'Teste unitário do contrato de wizard Services não encontrado.' },
