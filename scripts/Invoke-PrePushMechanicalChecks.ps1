...
try {
    ...
    foreach ($unitTest in @(
        ...
        [ordered]@{ Name = 'tests.scanProbe'; RelativePath = 'Tests\ScanProbe\Test-ApiPlanScanProbe.ps1'; Command = 'pwsh -NoProfile -File Tests/ScanProbe/Test-ApiPlanScanProbe.ps1'; Passed = 'Teste unitário do probe de medição B082 concluído.'; Failed = 'Teste unitário do probe de medição B082 falhou.'; Missing = 'Teste unitário do probe de medição B082 não encontrado.' },
        [ordered]@{ Name = 'tests.persistenceCore'; RelativePath = 'Tests\PersistenceProbe\Test-ApiPlanPersistenceCore.ps1'; Command = 'pwsh -NoProfile -File Tests/PersistenceProbe/Test-ApiPlanPersistenceCore.ps1'; Passed = 'Teste unitário do seam de persistência B111/F2 concluído.'; Failed = 'Teste unitário do seam de persistência B111/F2 falhou.'; Missing = 'Teste unitário do seam de persistência B111/F2 não encontrado.' },
        [ordered]@{ Name = 'tests.persistenceExecutor'; RelativePath = 'Tests\PersistenceProbe\Test-ApiPlanSaveStepExecutor.ps1'; Command = 'pwsh -NoProfile -File Tests/PersistenceProbe/Test-ApiPlanSaveStepExecutor.ps1'; Passed = 'Teste unitário do executor de persistência B111/F2 concluído.'; Failed = 'Teste unitário do executor de persistência B111/F2 falhou.'; Missing = 'Teste unitário do executor de persistência B111/F2 não encontrado.' },
        [ordered]@{ Name = 'tests.persistenceSeamCoverage'; RelativePath = 'Tests\PersistenceProbe\Test-ApiPlanPersistenceSeamCoverage.ps1'; Command = 'pwsh -NoProfile -File Tests/PersistenceProbe/Test-ApiPlanPersistenceSeamCoverage.ps1'; Passed = 'Sentinela de cobertura do seam de persistência B111/F2 concluída.'; Failed = 'Sentinela de cobertura do seam de persistência B111/F2 falhou.'; Missing = 'Sentinela de cobertura do seam de persistência B111/F2 não encontrada.' },
        [ordered]@{ Name = 'tests.operationJournalSchema'; RelativePath = 'Tests\OperationJournal\Test-ApiPlanOperationJournalSchema.ps1'; Command = 'pwsh -NoProfile -File Tests/OperationJournal/Test-ApiPlanOperationJournalSchema.ps1'; Passed = 'Teste do schema V1 e da serialização canônica do diário B111/F3 concluído.'; Failed = 'Teste do schema V1 e da serialização canônica do diário B111/F3 falhou.'; Missing = 'Teste do schema V1 e da serialização canônica do diário B111/F3 não encontrado.' },
        [ordered]@{ Name = 'tests.operationJournalCheckpoints'; RelativePath = 'Tests\OperationJournal\Test-ApiPlanOperationJournalCheckpoints.ps1'; Command = 'pwsh -NoProfile -File Tests/OperationJournal/Test-ApiPlanOperationJournalCheckpoints.ps1'; Passed = 'Teste da matriz de checkpoints do diário B111/F3 concluído.'; Failed = 'Teste da matriz de checkpoints do diário B111/F3 falhou.'; Missing = 'Teste da matriz de checkpoints do diário B111/F3 não encontrado.' },
        [ordered]@{ Name = 'tests.operationJournalGate'; RelativePath = 'Tests\OperationJournal\Test-ApiPlanOperationJournalGate.ps1'; Command = 'pwsh -NoProfile -File Tests/OperationJournal/Test-ApiPlanOperationJournalGate.ps1'; Passed = 'Teste da precedência de diagnóstico do gate estendido do diário B111/F3 concluído.'; Failed = 'Teste da precedência de diagnóstico do gate estendido do diário B111/F3 falhou.'; Missing = 'Teste da precedência de diagnóstico do gate estendido do diário B111/F3 não encontrado.' },
        [ordered]@{ Name = 'tests.operationJournalReceipts'; RelativePath = 'Tests\OperationJournal\Test-ApiPlanOperationJournalReceipts.ps1'; Command = 'pwsh -NoProfile -File Tests/OperationJournal/Test-ApiPlanOperationJournalReceipts.ps1'; Passed = 'Teste do transporte de recibos e inventário para o diário B111/F3 concluído.'; Failed = 'Teste do transporte de recibos e inventário para o diário B111/F3 falhou.'; Missing = 'Teste do transporte de recibos e inventário para o diário B111/F3 não encontrado.' },
        [ordered]@{ Name = 'tests.journalFrontierSentinel'; RelativePath = 'Tests\OperationJournal\Test-ApiPlanJournalFrontierSentinel.ps1'; Command = 'pwsh -NoProfile -File Tests/OperationJournal/Test-ApiPlanJournalFrontierSentinel.ps1'; Passed = 'Sentinela da fronteira do API Object e da identidade composta B111/F3 concluída.'; Failed = 'Sentinela da fronteira do API Object e da identidade composta B111/F3 falhou.'; Missing = 'Sentinela da fronteira do API Object e da identidade composta B111/F3 não encontrada.' },
        ...
        [ordered]@{ Name = 'tests.b082Etapa2Safety'; RelativePath = 'Tests\GeneratedApiRemoval\Test-ApiPlanB082Etapa2Safety.ps1'; Command = 'pwsh -NoProfile -File Tests/GeneratedApiRemoval/Test-ApiPlanB082Etapa2Safety.ps1'; Passed = 'Teste textual da B082 Etapa 2 (guarda, abort, Preview→Remove, Folder) concluído.'; Failed = 'Teste textual da B082 Etapa 2 (guarda, abort, Preview→Remove, Folder) falhou.'; Missing = 'Teste textual da B082 Etapa 2 não encontrado.' },
        [ordered]@{ Name = 'tests.b082Etapa1BIndex'; RelativePath = 'Tests\GeneratedApiRemoval\Test-ApiPlanB082Etapa1BIndex.ps1'; Command = 'pwsh -NoProfile -File Tests/GeneratedApiRemoval/Test-ApiPlanB082Etapa1BIndex.ps1'; Passed = 'Teste textual da B082 Etapa 1B (índice Nível B no Remover) concluído.'; Failed = 'Teste textual da B082 Etapa 1B (índice Nível B no Remover) falhou.'; Missing = 'Teste textual da B082 Etapa 1B não encontrado.' },
        [ordered]@{ Name = 'tests.orphanMetadataRecovery'; RelativePath = 'Tests\OrphanMetadataRecovery\Test-ApiPlanOrphanMetadataRecovery.ps1'; Command = 'pwsh -NoProfile -File Tests/OrphanMetadataRecovery/Test-ApiPlanOrphanMetadataRecovery.ps1'; Passed = 'Teste do contrato da recuperação de metadata órfã B115 concluído.'; Failed = 'Teste do contrato da recuperação de metadata órfã B115 falhou.'; Missing = 'Teste do contrato da recuperação de metadata órfã B115 não encontrado.' },
        [ordered]@{ Name = 'tests.operationJournalRecovery'; RelativePath = 'Tests\OperationJournal\Test-ApiPlanRecovery.ps1'; Command = 'pwsh -NoProfile -File Tests/OperationJournal/Test-ApiPlanRecovery.ps1'; Passed = 'Teste da reidratação e da autorização de recuperação B111/F3 concluído.'; Failed = 'Teste da reidratação e da autorização de recuperação B111/F3 falhou.'; Missing = 'Teste da reidratação e da autorização de recuperação B111/F3 não encontrado.'; EnvironmentBlocked = 'Ambiente sem DLL Release ou instalação GeneXus legível para a recuperação B111/F3.' },
        [ordered]@{ Name = 'tests.removalQueue'; RelativePath = 'Tests\GeneratedApiRemoval\Test-ApiPlanRemovalQueue.ps1'; Command = 'pwsh -NoProfile -File Tests/GeneratedApiRemoval/Test-ApiPlanRemovalQueue.ps1'; Passed = 'Teste da fila de remoção por passadas B111/F3 concluído.'; Failed = 'Teste da fila de remoção por passadas B111/F3 falhou.'; Missing = 'Teste da fila de remoção por passadas B111/F3 não encontrado.'; EnvironmentBlocked = 'Ambiente sem DLL Release ou instalação GeneXus legível para a fila de remoção B111/F3.' },
        [ordered]@{ Name = 'tests.generatedApiRemovalResilience'; RelativePath = 'Tests\GeneratedApiRemoval\Test-ApiPlanGeneratedApiRemovalResilience.ps1'; Command = 'pwsh -NoProfile -File Tests/GeneratedApiRemoval/Test-ApiPlanGeneratedApiRemovalResilience.ps1'; Passed = 'Teste da remoção resiliente à ordem e do relatório parcial concluído.'; Failed = 'Teste da remoção resiliente à ordem e do relatório parcial falhou.'; Missing = 'Teste da remoção resiliente à ordem e do relatório parcial não encontrado.' },
        ...
        [ordered]@{ Name = 'tests.transactionSyncSdtMemberSequenceMatcher'; RelativePath = 'Tests\TransactionSync\Test-ApiPlanTransactionSyncSdtMemberSequenceMatcher.ps1'; Command = 'pwsh -NoProfile -File Tests/TransactionSync/Test-ApiPlanTransactionSyncSdtMemberSequenceMatcher.ps1'; Passed = 'Teste unitário do reencontro de SDT com inclusões selecionadas concluído.'; Failed = 'Teste unitário do reencontro de SDT com inclusões selecionadas falhou.'; Missing = 'Teste unitário do reencontro de SDT com inclusões selecionadas não encontrado.' },
        ...
        [ordered]@{ Name = 'tests.kbIndexReuse'; RelativePath = 'Tests\KbIndexReuse\Test-ApiPlanKbIndexReuse.ps1'; Command = 'pwsh -NoProfile -File Tests/KbIndexReuse/Test-ApiPlanKbIndexReuse.ps1'; Passed = 'Teste unitário da reutilização do índice da KB concluído.'; Failed = 'Teste unitário da reutilização do índice da KB falhou.'; Missing = 'Teste unitário da reutilização do índice da KB não encontrado.' },
        ...
        [ordered]@{ Name = 'tests.writePreflightHierarchicalStructure'; RelativePath = 'Tests\WritePreflight\Test-ApiPlanWritePreflightHierarchicalStructure.ps1'; Command = 'pwsh -NoProfile -File Tests/WritePreflight/Test-ApiPlanWritePreflightHierarchicalStructure.ps1'; Passed = 'Teste unitário do preflight hierárquico de subnível sem nome concluído.'; Failed = 'Teste unitário do preflight hierárquico de subnível sem nome falhou.'; Missing = 'Teste unitário do preflight hierárquico de subnível sem nome não encontrado.' },
        [ordered]@{ Name = 'tests.writePreflightBusinessComponentGuard'; RelativePath = 'Tests\WritePreflight\Test-ApiPlanWritePreflightBusinessComponentGuard.ps1'; Command = 'pwsh -NoProfile -File Tests/WritePreflight/Test-ApiPlanWritePreflightBusinessComponentGuard.ps1'; Passed = 'Teste unitário da guarda B055 de Business Component concluído.'; Failed = 'Teste unitário da guarda B055 de Business Component falhou.'; Missing = 'Teste unitário da guarda B055 de Business Component não encontrado.' },
        ...
        [ordered]@{ Name = 'tests.generationBaseline'; RelativePath = 'Tests\GenerationBaseline\Test-ApiPlanGenerationBaseline.ps1'; Command = 'pwsh -NoProfile -File Tests/GenerationBaseline/Test-ApiPlanGenerationBaseline.ps1'; Passed = 'Teste unitário da linha de base de geração (Fase 0) concluído.'; Failed = 'Teste unitário da linha de base de geração (Fase 0) falhou.'; Missing = 'Teste unitário da linha de base de geração (Fase 0) não encontrado.'; EnvironmentBlocked = 'Ambiente sem DLL Release ou instalação GeneXus legível para a linha de base offline.' },
        [ordered]@{ Name = 'tests.transactionStructure'; RelativePath = 'Tests\TransactionStructure\Test-TransactionStructureReader.ps1'; Command = 'pwsh -NoProfile -File Tests/TransactionStructure/Test-TransactionStructureReader.ps1'; Passed = 'Teste unitário da leitura hierárquica B095 concluído.'; Failed = 'Teste unitário da leitura hierárquica B095 falhou.'; Missing = 'Teste unitário da leitura hierárquica B095 não encontrado.'; EnvironmentBlocked = 'Ambiente sem DLL Release ou instalação GeneXus legível para a leitura hierárquica B095.' },
        [ordered]@{ Name = 'tests.sdtHierarchicalPlan'; RelativePath = 'Tests\SdtHierarchicalPlan\Test-ApiPlanSdtHierarchicalPlan.ps1'; Command = 'pwsh -NoProfile -File Tests/SdtHierarchicalPlan/Test-ApiPlanSdtHierarchicalPlan.ps1'; Passed = 'Teste unitário do plano de SDT hierárquico B096 concluído.'; Failed = 'Teste unitário do plano de SDT hierárquico B096 falhou.'; Missing = 'Teste unitário do plano de SDT hierárquico B096 não encontrado.'; EnvironmentBlocked = 'Ambiente sem DLL Release ou instalação GeneXus legível para o plano de SDT hierárquico B096.' },
        [ordered]@{ Name = 'tests.businessComponentHierarchical'; RelativePath = 'Tests\BusinessComponentHierarchical\Test-ApiPlanBusinessComponentHierarchical.ps1'; Command = 'pwsh -NoProfile -File Tests/BusinessComponentHierarchical/Test-ApiPlanBusinessComponentHierarchical.ps1'; Passed = 'Teste unitário do Source BC hierárquico B097 concluído.'; Failed = 'Teste unitário do Source BC hierárquico B097 falhou.'; Missing = 'Teste unitário do Source BC hierárquico B097 não encontrado.'; EnvironmentBlocked = 'Ambiente sem DLL Release ou instalação GeneXus legível para o Source BC hierárquico B097.' },
        [ordered]@{ Name = 'tests.listHierarchical'; RelativePath = 'Tests\ListHierarchical\Test-ApiPlanListHierarchical.ps1'; Command = 'pwsh -NoProfile -File Tests/ListHierarchical/Test-ApiPlanListHierarchical.ps1'; Passed = 'Teste unitário do List hierárquico B098 concluído.'; Failed = 'Teste unitário do List hierárquico B098 falhou.'; Missing = 'Teste unitário do List hierárquico B098 não encontrado.'; EnvironmentBlocked = 'Ambiente sem DLL Release ou instalação GeneXus legível para o List hierárquico B098.' },
        [ordered]@{ Name = 'tests.wizardHierarchical'; RelativePath = 'Tests\WizardHierarchical\Test-ApiPlanHierarchicalWizardSelection.ps1'; Command = 'pwsh -NoProfile -File Tests/WizardHierarchical/Test-ApiPlanHierarchicalWizardSelection.ps1'; Passed = 'Teste unitário da seleção hierárquica do Wizard B099a concluído.'; Failed = 'Teste unitário da seleção hierárquica do Wizard B099a falhou.'; Missing = 'Teste unitário da seleção hierárquica do Wizard B099a não encontrado.'; EnvironmentBlocked = 'Ambiente sem DLL Release ou instalação GeneXus legível para a seleção hierárquica do Wizard B099a.' },
        [ordered]@{ Name = 'tests.wizardLifecycle'; RelativePath = 'Tests\WizardLifecycle\Test-ApiPlanWizardHierarchicalLifecycle.ps1'; Command = 'pwsh -NoProfile -File Tests/WizardLifecycle/Test-ApiPlanWizardHierarchicalLifecycle.ps1'; Passed = 'Teste unitário do ciclo de vida hierárquico do Wizard (Fase 7) concluído.'; Failed = 'Teste unitário do ciclo de vida hierárquico do Wizard (Fase 7) falhou.'; Missing = 'Teste unitário do ciclo de vida hierárquico do Wizard (Fase 7) não encontrado.' },
        [ordered]@{ Name = 'tests.metadataHierarchical'; RelativePath = 'Tests\MetadataHierarchical\Test-ApiPlanMetadataLevels.ps1'; Command = 'pwsh -NoProfile -File Tests/MetadataHierarchical/Test-ApiPlanMetadataLevels.ps1'; Passed = 'Teste unitário da metadata hierárquica B099b concluído.'; Failed = 'Teste unitário da metadata hierárquica B099b falhou.'; Missing = 'Teste unitário da metadata hierárquica B099b não encontrado.'; EnvironmentBlocked = 'Ambiente sem DLL Release ou instalação GeneXus legível para a metadata hierárquica B099b.' },
        [ordered]@{ Name = 'tests.wizardContractNoAcceptRuleReader'; RelativePath = 'Tests\WizardContract\Test-PrototypeWizardNoAcceptRuleReader.ps1'; Command = 'pwsh -NoProfile -File Tests/WizardContract/Test-PrototypeWizardNoAcceptRuleReader.ps1'; Passed = 'Teste unitário da leitura de regras NoAccept concluído.'; Failed = 'Teste unitário da leitura de regras NoAccept falhou.'; Missing = 'Teste unitário da leitura de regras NoAccept não encontrado.' },
        [ordered]@{ Name = 'tests.wizardContractNoAcceptRequestEligibility'; RelativePath = 'Tests\WizardContract\Test-NoAcceptRequestEligibilityContract.ps1'; Command = 'pwsh -NoProfile -File Tests/WizardContract/Test-NoAcceptRequestEligibilityContract.ps1'; Passed = 'Teste unitário da elegibilidade de requests NoAccept concluído.'; Failed = 'Teste unitário da elegibilidade de requests NoAccept falhou.'; Missing = 'Teste unitário da elegibilidade de requests NoAccept não encontrado.' },
        [ordered]@{ Name = 'tests.wizardContractExistingApiFilters'; RelativePath = 'Tests\WizardContract\Test-PrototypeWizardExistingApiFilters.ps1'; Command = 'pwsh -NoProfile -File Tests/WizardContract/Test-PrototypeWizardExistingApiFilters.ps1'; Passed = 'Teste unitário dos filtros e restauração de API existente do wizard concluído.'; Failed = 'Teste unitário dos filtros e restauração de API existente do wizard falhou.'; Missing = 'Teste unitário dos filtros e restauração de API existente do wizard não encontrado.' },
        [ordered]@{ Name = 'tests.wizardContractServiceSourceParsing'; RelativePath = 'Tests\WizardContract\Test-PrototypeWizardServiceSourceParsing.ps1'; Command = 'pwsh -NoProfile -File Tests/WizardContract/Test-PrototypeWizardServiceSourceParsing.ps1'; Passed = 'Teste unitário do parser de Service Source do wizard concluído.'; Failed = 'Teste unitário do parser de Service Source do wizard falhou.'; Missing = 'Teste unitário do parser de Service Source do wizard não encontrado.' },
        [ordered]@{ Name = 'tests.extensionAssemblyInventory'; RelativePath = 'Tests\ExtensionAssemblyInventory\Test-ExtensionAssemblyInventory.ps1'; Command = 'pwsh -NoProfile -File Tests/ExtensionAssemblyInventory/Test-ExtensionAssemblyInventory.ps1'; Passed = 'Teste unitário do inventário offline da assembly concluído.'; Failed = 'Teste unitário do inventário offline da assembly falhou.'; Missing = 'Teste unitário do inventário offline da assembly não encontrado.' },
        [ordered]@{ Name = 'tests.installationBatPathHandling'; RelativePath = 'Tests\Installation\Test-InstallExtensionBatPathHandling.ps1'; Command = 'pwsh -NoProfile -File Tests/Installation/Test-InstallExtensionBatPathHandling.ps1'; Passed = 'Teste unitário do tratamento de caminhos dos BATs concluído.'; Failed = 'Teste unitário do tratamento de caminhos dos BATs falhou.'; Missing = 'Teste unitário do tratamento de caminhos dos BATs não encontrado.' },
        [ordered]@{ Name = 'tests.extensionLanguage'; RelativePath = 'Tests\Localization\Test-ExtensionLanguage.ps1'; Command = 'pwsh -NoProfile -File Tests/Localization/Test-ExtensionLanguage.ps1'; Passed = 'Teste unitário da resolução do idioma da extensão concluído.'; Failed = 'Teste unitário da resolução do idioma da extensão falhou.'; Missing = 'Teste unitário da resolução do idioma da extensão não encontrado.' },
